...
- 📨 **MQ** — Kafka / RabbitMQ / RocketMQ / ActiveMQ / ZeroMQ / Pulsar / NATS plus MQTT / MQTT brokers (MQTT / EMQX / HiveMQ / Mosquitto / NanoMQ / VerneMQ): keep the connection config and topic, then generate producer / consumer code (10+ languages); the tree shows the icon of the selected message broker
