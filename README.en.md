...
- 🖥️ **System tray**: closing the window minimizes to tray; tray menu can show/hide the window, start/stop the Mock server, or quit
...
- 🌐 Full support for **path params / Query / Headers / Body**
...
- Tray menu: show window / hide window / start·stop Mock server / quit
