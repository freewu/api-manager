    ...
    () =>
      (
        [
          ...
          { value: "apidog", label: t("export.apidog") },
          { value: "bruno", label: t("export.bruno") },
          { value: "apizza", label: t("export.apizza") },
          { value: "nei", label: t("export.nei") },
          { value: "doclever", label: t("export.doclever") },
          { value: "io-docs", label: t("export.io-docs") },
          { value: "easydoc", label: t("export.easydoc") },
