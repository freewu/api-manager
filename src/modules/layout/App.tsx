...
import { CurlImportModal } from "../export/CurlImportModal";
import ImportResultModal from "../export/ImportResultModal";
...
const ApiDocModal = lazy(() =>
  import("../apidoc/ApiDocModal").then((m) => ({ default: m.ApiDocModal }))
);
