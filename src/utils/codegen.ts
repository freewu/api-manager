...
function genWsPowershell(r: WsReq): string {
...
function genWsLuaDispatch(r: WsReq, lib?: string): string {
  switch (lib) {
    case "standalone":
...
function genWsLuaResty(r: WsReq): string {
  const out: string[] = [];
...
function genWsLuaStandalone(r: WsReq): string {
  const out: string[] = [];
