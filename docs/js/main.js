...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "hero.download": "下载安装",
      "hero.github": "查看源码",
      "hero.badge.postman": "🎨 Postman 风格",
      "hero.badge.standalone": "📦 单文件分发",
      "hero.badge.protocols": "🔌 8 种协议接口",
      "hero.badge.shortcuts": "⌨️ 全局快捷键",
      "features.title": "功能特性",
      ...
      "f5.title": "一键导出",
      "f5.desc": "28 种导出格式：Postman Collection、OpenAPI 3.0（JSON / YAML，默认 YAML）、Apifox、Apipost、Insomnia、JMeter、RAML、WADL、HAR，以及 Docsify / MkDocs / Markdown / HTML 文档站点。",
      "f6.title": "代码生成",
      ...
      "f9.title": "多格式导入",
      "f9.desc": "26 种导入格式：Postman Collection、OpenAPI (Swagger，JSON / YAML)、Markdown、Apifox、Apipost、cURL 等；接口与集合变量一键迁移，导入菜单可按需配置。",
      "f10.title": "版本管理",
      "f10.desc": "接口可保存多个版本，左右对比差异，随时回退到任意历史版本。",
      "f11.title": "统计",
      "f11.desc": "分组 / 工作区维度统计接口数、Mock 启用数与请求方法分布，一目了然。",
      "f12.title": "灵活设置",
      "f12.desc": "12 个设置页签：工作区、语言、外观、接口版本、Mock 服务、代码生成、导出、导入、默认 Header、快捷键、同步远程、关于（技术栈徽章与开源组件清单），打造个性化工作环境。",
      "f13.title": "对象管理",
      "f13.desc": "分组 + 对象管理数据结构：属性配置（类型 / 引用对象 / Mock 值 / 描述），支持 JSON 与 SQL 建表语句导入，一键生成多语言代码与 MySQL 建表语句。",
      "f14.title": "数据生成",
      "f14.desc": "按对象属性批量生成测试数据（JSON / SQL / CSV），自定义表名与记录数；生成记录展示耗时与文件大小，可一键重新生成。",
      "f15.title": "多协议接口",
      "f15.desc": "新建接口支持 HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP 八种协议，一套工作区、一棵接口树统一管理。",
      "f16.title": "收藏接口",
      "f16.desc": "接口右键选择「收藏」即可加入收藏视图，支持拖动排序，并拥有独立的编辑面板，常用接口触手可及。",
      "f17.title": "全局快捷键",
      "f17.desc": "9 个可自定义快捷键：视图切换（接口 / 对象 / 历史 / 生成记录 / 收藏）、导入导出、设置与环境管理，在设置中点击录制即可改键。",
      "f18.title": "Markdown 接口描述",
      "f18.desc": "接口「描述」页签内置 Vditor Markdown 编辑器，所见即所得 + 高亮只读预览；全部资源本地化打包，完全离线可用。",
      ...
      "cap.export": "一键导出 —— 28 种格式：OpenAPI 3.0 JSON / YAML、Postman、Docsify 等",
      "cap.codegen": "代码生成 —— 20+ 种语言 / 框架的请求代码一键生成",
      "cap.env": "全局环境变量 —— 多环境切换，{{变量名}} 自动替换到请求各处",
      "cap.history": "请求历史 —— 自动记录，一键回填重发",
      "cap.import": "多格式导入 —— 26 种格式：Postman / OpenAPI（JSON / YAML）/ Markdown / cURL",
      ...
      "cap.objects": "对象管理 —— 分组 + 对象管理数据结构，属性支持类型 / 引用对象 / Mock 值 / 描述",
      "cap.apiadd": "新建接口 —— 支持 HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP 八种协议",
      "cap.datagen": "数据生成 —— 按对象属性批量生成测试数据，支持 JSON / SQL / CSV",
      "cap.genlog": "生成记录 —— 展示耗时与文件大小，支持一键重新生成",
      "cap.setting": "设置 —— 12 个页签，含快捷键、技术栈徽章与开源组件清单",
    ...
    tw: {
      ...
      "hero.download": "下載安裝",
      "hero.github": "查看源碼",
      "hero.badge.postman": "🎨 Postman 風格",
      "hero.badge.standalone": "📦 單文件分發",
      "hero.badge.protocols": "🔌 8 種協議接口",
      "hero.badge.shortcuts": "⌨️ 全局快捷鍵",
      "features.title": "功能特性",
      ...
      "f5.title": "一鍵導出",
      "f5.desc": "28 種導出格式：Postman Collection、OpenAPI 3.0（JSON / YAML，默認 YAML）、Apifox、Apipost、Insomnia、JMeter、RAML、WADL、HAR，以及 Docsify / MkDocs / Markdown / HTML 文檔站點。",
      "f6.title": "代碼生成",
      ...
      "f9.title": "多格式導入",
      "f9.desc": "26 種導入格式：Postman Collection、OpenAPI (Swagger，JSON / YAML)、Markdown、Apifox、Apipost、cURL 等；接口與集合變量一鍵遷移，導入菜單可按需配置。",
      "f10.title": "版本管理",
      "f10.desc": "接口可保存多個版本，左右對比差異，隨時回退到任意歷史版本。",
      "f11.title": "統計",
      "f11.desc": "分組 / 工作區維度統計接口數、Mock 啟用數與請求方法分佈，一目瞭然。",
      "f12.title": "靈活設置",
      "f12.desc": "12 個設置頁籤：工作區、語言、外觀、接口版本、Mock 服務、代碼生成、導出、導入、默認 Header、快捷鍵、同步遠程、關於（技術棧徽章與開源組件清單），打造個性化工作環境。",
      "f13.title": "對象管理",
      "f13.desc": "分組 + 對象管理數據結構：屬性配置（類型 / 引用對象 / Mock 值 / 描述），支持 JSON 與 SQL 建表語句導入，一鍵生成多語言代碼與 MySQL 建表語句。",
      "f14.title": "數據生成",
      "f14.desc": "按對象屬性批量生成測試數據（JSON / SQL / CSV），自定義表名與記錄數；生成記錄展示耗時與文件大小，可一鍵重新生成。",
      "f15.title": "多協議接口",
      "f15.desc": "新建接口支持 HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP 八種協議，一套工作區、一棵接口樹統一管理。",
      "f16.title": "收藏接口",
      "f16.desc": "接口右鍵選擇「收藏」即可加入收藏視圖，支持拖動排序，並擁有獨立的編輯面板，常用接口觸手可及。",
      "f17.title": "全局快捷鍵",
      "f17.desc": "9 個可自定義快捷鍵：視圖切換（接口 / 對象 / 歷史 / 生成記錄 / 收藏）、導入導出、設置與環境管理，在設置中點擊錄製即可改鍵。",
      "f18.title": "Markdown 接口描述",
      "f18.desc": "接口「描述」頁籤內置 Vditor Markdown 編輯器，所見即所得 + 高亮只讀預覽；全部資源本地化打包，完全離線可用。",
      ...
      "cap.export": "一鍵導出 —— 28 種格式：OpenAPI 3.0 JSON / YAML、Postman、Docsify 等",
      "cap.codegen": "代碼生成 —— 20+ 種語言 / 框架的請求代碼一鍵生成",
      "cap.env": "全局環境變量 —— 多環境切換，{{變量名}} 自動替換到請求各處",
      "cap.history": "請求歷史 —— 自動記錄，一鍵回填重發",
      "cap.import": "多格式導入 —— 26 種格式：Postman / OpenAPI（JSON / YAML）/ Markdown / cURL",
      ...
      "cap.objects": "對象管理 —— 分組 + 對象管理數據結構，屬性支持類型 / 引用對象 / Mock 值 / 描述",
      "cap.apiadd": "新建接口 —— 支持 HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP 八種協議",
      "cap.datagen": "數據生成 —— 按對象屬性批量生成測試數據，支持 JSON / SQL / CSV",
      "cap.genlog": "生成記錄 —— 展示耗時與文件大小，支持一鍵重新生成",
      "cap.setting": "設置 —— 12 個頁籤，含快捷鍵、技術棧徽章與開源組件清單",
    ...
    en: {
      ...
      "hero.badge.postman": "🎨 Postman-style UI",
      "hero.badge.standalone": "📦 Single-file distribution",
      "hero.badge.protocols": "🔌 8 protocols",
      "hero.badge.shortcuts": "⌨️ Global shortcuts",
      ...
      "f5.desc": "Export in 28 formats: Postman Collection, OpenAPI 3.0 (JSON & YAML — YAML by default), Apifox, Apipost, Insomnia, JMeter, RAML, WADL, HAR, plus Docsify / MkDocs / Markdown / HTML documentation sites.",
      ...
      "f9.desc": "Import from 26 formats: Postman Collection, OpenAPI (Swagger, JSON & YAML), Markdown, Apifox, Apipost, cURL and more — APIs and collection variables migrate in one click, and the import menu is configurable.",
      ...
      "f12.desc": "12 settings tabs: workspace, language, appearance, API versions, Mock server, code generation, export, import, default headers, shortcuts, remote sync and about (tech-stack badges & open-source component list).",
      "f13.title": "Object Manager",
      "f13.desc": "Manage data structures with groups & objects — configure property type, referenced object, Mock value & description; import from JSON or SQL DDL; generate multi-language code and MySQL DDL in one click.",
      "f14.title": "Data Generation",
      "f14.desc": "Batch-generate test data from object properties (JSON / SQL / CSV) with a custom table name & record count; logs show elapsed time & file size and support one-click regeneration.",
      "f15.title": "Multi-protocol APIs",
      "f15.desc": "Create APIs over HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP — one workspace and one API tree for every protocol.",
      "f16.title": "Favorites",
      "f16.desc": "Right-click an API → Favorite to collect it in the Favorites view, with drag-and-drop ordering and a dedicated editor pane.",
      "f17.title": "Global Shortcuts",
      "f17.desc": "9 rebindable shortcuts for view switching (APIs / objects / history / generation logs / favorites), import & export, settings and environments — record new keys in Settings.",
      "f18.title": "Markdown API Description",
      "f18.desc": "The Description tab ships a full Vditor Markdown editor with WYSIWYG editing and a highlighted read mode; every asset is bundled locally, so it works fully offline.",
      ...
      "cap.export": "One-click Export — 28 formats: OpenAPI 3.0 JSON / YAML, Postman, Docsify and more",
      ...
      "cap.import": "Multi-format Import — 26 formats: Postman / OpenAPI (JSON & YAML) / Markdown / cURL",
      ...
      "cap.objects": "Object Manager — manage data structures with groups & objects; properties support type, referenced object, Mock value & description",
      "cap.apiadd": "New API — HTTP / WebSocket / Socket.IO / GraphQL / WebDAV / MCP / TCP / UDP",
      "cap.datagen": "Data Generation — batch-generate test data from object properties (JSON / SQL / CSV)",
      "cap.genlog": "Generation Logs — records elapsed time & file size, re-generate with one click",
      "cap.setting": "Settings — 12 tabs incl. shortcuts, tech-stack badges and the open-source component list",
