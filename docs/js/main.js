...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "f15.title": "多协议接口",
      "f15.desc": "新建接口支持 HTTP / WebSocket / Socket.IO / GraphQL 四种协议，一套工作区统一管理。",
      ...
      "cap.apiadd": "新建接口 —— 支持 HTTP / WebSocket / Socket.IO / GraphQL 四种协议",
    ...
    tw: {
      ...
      "f15.title": "多協議接口",
      "f15.desc": "新建接口支持 HTTP / WebSocket / Socket.IO / GraphQL 四種協議，一套工作區統一管理。",
      ...
      "cap.apiadd": "新建接口 —— 支持 HTTP / WebSocket / Socket.IO / GraphQL 四種協議",
    ...
    en: {
      ...
      "f15.desc": "Create APIs over HTTP / WebSocket / Socket.IO / GraphQL — all managed in one workspace.",
      ...
      "cap.apiadd": "New API — create APIs over HTTP / WebSocket / Socket.IO / GraphQL",
