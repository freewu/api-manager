...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "f12.title": "灵活设置",
      "f12.desc": "12 个设置页签：工作区、语言、外观、接口版本、Mock 服务、代码生成、导出、导入、默认 Header、快捷键、同步远程、关于（开源组件清单），打造个性化工作环境。",
      "f13.title": "对象管理",
      ...
      "cap.setting": "设置 —— 12 个页签，含快捷键、导入导出格式与开源组件清单",
    ...
    tw: {
      ...
      "f12.title": "靈活設置",
      "f12.desc": "12 個設置頁籤：工作區、語言、外觀、接口版本、Mock 服務、代碼生成、導出、導入、默認 Header、快捷鍵、同步遠程、關於（開源組件清單），打造個性化工作環境。",
      "f13.title": "對象管理",
      ...
      "cap.setting": "設置 —— 12 個頁籤，含快捷鍵、導入導出格式與開源組件清單",
    ...
    en: {
      ...
      "f12.desc": "12 settings tabs: workspace, language, appearance, API versions, Mock server, code generation, export, import, default headers, shortcuts, remote sync and about (open-source component list).",
      ...
      "cap.setting": "Settings — 12 tabs incl. shortcuts, import/export formats and the open-source component list",
